...
export default function SignInPage() {
  return (
    <div className="min-h-dvh flex items-center justify-center px-4 bg-gradient-to-b from-surface-50 to-surface-0">
      <motion.div
        ...
        <div className="bg-glass rounded-2xl p-6 space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl
              bg-white text-gray-900 font-semibold hover:bg-white/90 transition-all"
          >
